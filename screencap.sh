...
# Configuration - Video
if [[ $HUFF == "true" ]]; then
    vstring="-f x11grab -s hd1080 -r 30 -i :0.0 -vcodec huffyuv -pix_fmt yuv422p"
    vmethod="huffyuv"
else
    vstring="-f x11grab -s hd1080 -r 30 -i :0.0 -vcodec libx264 -preset ultrafast -pix_fmt yuv422p"
    vmethod="libx264"
fi
